...
public class SelectorPaginado {
     ...
     */
    public int seleccionarMatricula(List<Matricula> matriculas) {
    ...
    private void mostrarMatriculasPaginadas(List<Matricula> matriculas, int pagina, int totalPaginas) {
        ...
        for (int i = inicio; i < fin; i++) {
            ...
            String[] fila = {
                String.valueOf(mat.getId()),
                String.valueOf(mat.getIdEstudiante()),
                String.valueOf(mat.getIdCurso()),
                mat.getFecha().toString(),
                mat.getEstado().toString()
            };
            Utilidades.imprimirFila(fila, anchos);
        }
